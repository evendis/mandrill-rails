...
Mandrill now supports {webhook authentication}[http://help.mandrill.com/entries/23704122-Authenticating-webhook-requests] which can help prevent unauthorised posting to your webhook handlers. You con find and reset your API keys on the
...
To enable authentication, use the <tt>mandrill_webhook_keys</tt> method to set your API key. It is recommended you configure
your API keys as environment settings, or use some other means to avoid committing the API keys to your source code.
