...
To enable authentication, use the <tt>mandrill_webhook_keys</tt> method to set your API key, and add a <tt>authenticate_mandrill_request!</tt> before_filter. It is recommended you pull
...
For example, to handle inbound email:
    ...
    class InboxController < ApplicationController
      ...
      # 403 Forbidden response will fire and execution will stop here for non-HEAD requests unless signature is valid
      before_filter :authenticate_mandrill_request!
